...
export function parseTastedFilterMode(
  input: unknown,
): ParseResult<z.infer<typeof tastedFilterModeSchema>> {
  return toParseResult(tastedFilterModeSchema, input);
}
